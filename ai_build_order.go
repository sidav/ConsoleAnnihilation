...
var ai_allBuildOrders = [][]*ai_buildOrderStep{
	...
	// order 1: 2 KBot Labs
	{
		{desiredMIncome: 5, desiredEIncome: 100, desiredEngineers: 1, buildCode: "armkbotlab", buildCodeAlt: "corekbotlab"},
	...
	{
		{desiredMIncome: 5, desiredEIncome: 100, desiredEngineers: 1, buildCode: "armvehfactory", buildCodeAlt: "corevehfactory"},
	...
	{
		{desiredMIncome: 5, desiredEIncome: 100, desiredEngineers: 2, buildCode: "armkbotlab", buildCodeAlt: "corekbotlab"},
		{desiredMIncome: 5, desiredEIncome: 0, desiredEngineers: 3, buildCode: "armt2kbotlab", buildCodeAlt: "coret2kbotlab"},
